...
public class CommandService extends Service {
    ...
    public Command getCommand(String text) throws SQLException, CommandNotFoundException {
        //здесь происходит какая-то магия написанная не мной и в которой мне лень разбираться
        if (text != null) {
        ...
        //получаем кнопку на основе полученного текста через ButtonDao
        Button button = buttonDao.getButton(text);

        //возвращаем команду через commandDao
