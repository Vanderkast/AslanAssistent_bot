...
public class Bot extends TelegramLongPollingBot {
    ...
    //при появление разговора
    //проверяется есть ли уже такой разговор
    //если нет то создается новый и записывается в hash map <long id, conversation)
...
//        return "185897101:AAFSyBZqwVv-ooQ_zpCr9Bgt2H7_ekj11oA";/*prod*/
        return "366056739:AAGSM6ZZ1EgApi19NJXt4G4XVcYI7ADznPk";/*q_personal_assistant*/
    }
}
